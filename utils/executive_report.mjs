...
export function renderExecutiveReport(model, brand, { renderedAt = new Date() } = {}) {
  ...
  const version = (tier === 'enterprise' && model.eeVersion) ? model.eeVersion : (model.ceVersion ?? '0.0.0');
...
<footer>Generated by NSAuditor AI ${escapeHtml(tier)} ${escapeHtml(String(version))}</footer>
</body>
</html>`;
}
