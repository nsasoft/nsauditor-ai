...
- 🛡️ **GCP false-negative hardening** (Enterprise 0.18.0 — paired CE 0.2.1, docs-only) — four substrate-depth false-negative closures in the GCP auditors, all on already-covered controls (no new controls):
